...
@section('title', 'Edit Memberships')
  ...
  <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <form action="/memberships/{{ $membership->id }}" method="post">
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control" id="portfolio" name="portfolio" value="{{ $membership->portfolio }}">
      </div>
      <div class="mb-3">
